...
def input_parse(): # Function to parse command line arguments.
    ...
    parser.add_argument("--out", help="Folder where vectorizer is saved", type=str, default="models")
    ...
    #parser.add_argument("--vectorizer", help="Type of vectorizer", type=str, default="TfidfVectorizer")
...
def multidump(vectorizer, X_train_feats, X_test_feats, y_train, y_test, out_arg):
    dump(vectorizer, os.path.join(os.getcwd(), out_arg, "vectorizer.joblib"))
...
def main():
    ...
    multidump(vectorizer, X_train_feats, X_test_feats, y_train, y_test, args.out)
